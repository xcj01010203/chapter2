  ...
  <div class="am-g">
    <div class="am-u-md-7 am-u-sm-10 am-u-sm-centered am-radius am-animation-fade am-padding-top-xl shy-body">
      <div class="am-animation-scale-up am-margin-top-xl">
        <p class="am-text-xl am-text-center">请填写以下信息修改密码</p>
        <!--注册表单-->
        <div class="am-g">
          <div class="am-u-lg-7 am-u-sm-centered">
            <form class="am-form am-form-horizontal">
              ...
              <div class="am-form-group">
                <input class="am-input-sm" type="text" placeholder="新密码">
              </div>
              <div class="am-form-group">
                <input class="am-input-sm" type="text" placeholder="确认密码">
              </div>
              <button type="submit"
                      class="am-btn am-btn-primary am-btn-block am-btn-sm am-margin-bottom-xs am-radius">确定
              </button>
            </form>
          </div>
        </div>
